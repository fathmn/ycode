    ...
    <>
      ...
      <div className="mt-3 space-y-8">
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <FieldDescription className="flex flex-col gap-2">
            <span>
              Copy elements in the Webflow Designer and paste them onto the Studio
          ...
          <div className="border rounded-lg bg-secondary/30 p-3">
            ...
            <ol className="list-decimal list-inside space-y-1 text-xs text-muted-foreground">
              ...
              <li>Click the Studio canvas and paste to import the design.</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <ConfirmDialog
        ...
        description="Dadurch werden der CMS-Token, die Design-Site-URL und alle Import-Einträge entfernt. Studio-Collections aus früheren Migrationen bleiben erhalten."
