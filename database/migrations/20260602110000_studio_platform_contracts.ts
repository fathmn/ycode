...
const studioPlatformContractsSql = `
...
export async function up(knex: Knex): Promise<void> {
  await knex.schema.raw(studioPlatformContractsSql);
}

export async function down(_knex: Knex): Promise<void> {
  // Deliberately no-op: this migration renames live platform tables and should
  // not roll them back to company-branded identifiers.
}
