...
export async function up(knex: Knex): Promise<void> {
  ...
  // Insert Studio-branded defaults for new apps.
  await knex('settings').insert([
    { key: 'site_name', value: JSON.stringify('Studio') },
    { key: 'site_description', value: JSON.stringify('Website editor by studio.novum partners') },
    { key: 'ycode_version', value: JSON.stringify('0.1.0') },
    { key: 'sitemap', value: JSON.stringify(getDefaultSitemapSettings()) },
    { key: 'ycode_badge', value: JSON.stringify(false) },
